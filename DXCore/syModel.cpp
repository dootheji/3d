...
{
	//m_iTextureList.push_back(I_TextureMgr.Load(m_pDevice, L"../../data/bitmap/Mario - Walk2.gif"));
	//m_iTextureList.push_back(I_TextureMgr.Load(m_pDevice, L"../../data/bitmap/Mario - Walk1.gif"));
	//m_iTextureList.push_back(I_TextureMgr.Load(m_pDevice, L"../../data/bitmap/Mario - Walk3.gif"));
	//m_iTextureList.push_back(I_TextureMgr.Load(m_pDevice, L"../../data/bitmap/Mario - Walk2.gif"));
	//m_dxObj.m_pSRV = I_TextureMgr.GetPtr(m_iTextureList[0])->m_pSRV;
